...
// this는 함수를 실행시키는 context인데, 여기서는 demo1이 함수를 실행시키는 컨텍스트이다.

demo1.onclick = function() { // 여기서 demo1은 function(){}을 실행시키고, 
  // Function.prototype.call 메소드를 사용하여 함수를 빌려쓰기 패턴
  myFn();          // 결과: this === window object
  myFn.call(this); // 결과: this === demo1 
  console.log('내꺼 테스트용1:', this);
};
